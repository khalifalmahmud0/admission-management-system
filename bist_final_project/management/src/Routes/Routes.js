    ...
    return (
      <BrowserRouter>
        <Switch>
          ...
          <Route path="/profile" component={ProfileUpdatePage} exact />
          <Route path="/profile/update-info" component={ProfileUpdatePage} />
          <Route
            path="/profile/update-social"
            component={ProfileSocialChangePage}
          />
          <Route path="/profile/update-pass" component={ProfilePassChange} />

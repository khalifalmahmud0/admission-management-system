    ...
    <div class="content ">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <span>
                        <img src="image/bkashDuchbanglaCashLOGO/DBBL-logo.jpg" alt="bkash" height="90" width="90" class="payementimage">
                        <h4 class="payementtype">Dutch-Bangla Mobile Banking</h4> 
                    </span>

    ...
    <div class="content ">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <span>
                        <img src="image/bkashDuchbanglaCashLOGO/hand-money-il.png" alt="bkash" height="90" width="90" class="payementimage">
                        <h4 class="payementtype"> Cash </h4> 
                    </span>
...
<!-- //department -->
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <select class="form-control" id="department"  required="" name="departmentchoice">
                    <option class="form-control" >---Select your Department---</option>
                    <?php 
                    $sql = "SELECT 
                    id,
                    DEPname
...
// output data of each row
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <input required="" type="text" class="form-control" name="amountamount" id="status"  value="">
                </div>
              </div>
        ...
        success: function(response){
          document.getElementById("status").value=response; 
              ...
              <!-- //department end  -->
                            ...
                            <div class="form-group">
                                <label for="description" class="col-sm-3 control-label">Enter cash recept. No </label>
                                <div class="col-sm-9">
                                    <input   required=""   type="text" class="form-control" id="description" name="cashrecept">
                                </div>
                            </div> 

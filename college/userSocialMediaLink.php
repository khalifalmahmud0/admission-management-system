            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <form action="userSocialMediaDB.php" method="POSt" accept-charset="utf-8">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>FaceBook Link</label>
                                        <input name="FaceBookLink" type="text" class="form-control" required="">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input name="TwitterLink" type="text" class="form-control" required="">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="GooglePlusLink" required="">
                                    </div>
                                </div>
